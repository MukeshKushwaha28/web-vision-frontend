...
export default function TeamCards() {
  return (
    <div className=" h-auto md:h-[60vh] bg-gray-900 flex justify-center items-center py-10">
...
function TeamCard({ member }) {
  ...
  return (
    <div
      className={`relative bg-white rounded-xl shadow-lg p-4 w-80 transition-all duration-300 hover:shadow-2xl overflow-hidden ${
        hover ? "pt-10" : "pt-6"
